...
//
//go:embed assets/Dockerfile assets/bashrc.sh assets/entrypoint.sh assets/sdd-helpers.sh assets/zshrc.sh assets/starship.toml assets/xterm-ghostty.src assets/init.d
var Assets embed.FS
