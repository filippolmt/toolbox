...
## Corpus Check
- 132 files · ~97,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 453 nodes · 814 edges · 29 communities (28 shown, 1 thin omitted)
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `55884d21`
...
Cohesion: 0.06
Nodes (37): runBuild(), runShell(), signalCtx(), TestSignalCtxReturnsCancellableContext(), runStop(), createAndStart(), dispatchOp(), formatPublishMismatch() (+29 more)
...
### Community 19 - "Teardown Mock Client"
Cohesion: 0.5
...
## Knowledge Gaps
- **12 isolated node(s):** `Answer`, `Source Nodes`, `Result`, `Identity`, `Config` (+7 more)
...
- **Are the 24 inferred relationships involving `Shell()` (e.g. with `Warning()` and `OnShellExit()`) actually correct?**
...
- **What connects `Answer`, `Source Nodes`, `Result` to the rest of the system?**
